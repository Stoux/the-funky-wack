...
<template>
    ...
    <div class="min-h-screen p-4">
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <!-- Empty state -->
            <div v-if="liveSessions.length === 0" class="text-center py-16">
            ...
            <div v-else class="space-y-3">
                ...
                >
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <p class="font-medium">{{ session.host.name }}</p>
                            ...
                            <div class="flex items-center space-x-3 text-xs text-muted-foreground mt-1">
                                ...
                                <span v-if="session.listeners_count > 0" class="flex items-center space-x-1">
                                    <Users class="h-3 w-3" />
                                    <span>{{ session.listeners_count }}</span>
                                </span>
                            </div>
                        </div>
                    </div>

                    <ListenAlongSheet :session="session" />
                </div>
            </div>
        </div>
    </div>
